              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3 mb-5">
                  <div className="p-3 rounded-lg bg-white/[0.03]">
                    <p className="text-xs text-muted mb-0.5">Начало подписки</p>
                    <p className="text-sm font-medium text-white">
                      {new Date(subscription.startDate).toLocaleDateString("ru-RU")}
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-white/[0.03]">
                    <p className="text-xs text-muted mb-0.5">Окончание подписки</p>
                    <p className="text-sm font-medium text-white">
      ...
      <Card>
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-medium text-white">Обновления сервиса</h3>
          </div>
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-white/[0.02]">
              ...
              <div>
                <p className="text-sm text-white">Добавлен новый сервер в Финляндии</p>
                <p className="text-xs text-muted">15 июля 2026</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-white/[0.02]">
              <div className="h-2 w-2 rounded-full bg-accent-blue mt-1.5 shrink-0" />
              <div>
                <p className="text-sm text-white">Обновлены приложения для iOS и Android</p>
                <p className="text-xs text-muted">10 июля 2026</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-white/[0.02]">
              <div className="h-2 w-2 rounded-full bg-green-400 mt-1.5 shrink-0" />
              <div>
                <p className="text-sm text-white">Увеличена скорость серверов в Германии</p>
                <p className="text-xs text-muted">5 июля 2026</p>
              </div>
            </div>
          </div>
        </CardContent>
